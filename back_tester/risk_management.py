...
class AdaptiveRiskManager:
    ...
    def calculate_position_size(
        ...
        adjusted_risk_pct = max(min(adjusted_risk_pct, self.max_risk_pct), self.min_risk_pct)
    ...
    def _adjust_for_volatility(self, price: float, atr: float) -> float:
        ...
        # If volatility is lower than normal, can slightly increase risk
            ...
            adjustment = 1 + ((normal_volatility - normalized_atr) / normal_volatility) * 0.2
    ...
    def _adjust_for_streaks(self) -> float:
        ...
        # Decrease risk after consecutive losses
            ...
            loss_adjustment = min(self.consecutive_losses * self.loss_streak_factor, 0.5)
    ...
    def calculate_initial_stop_loss(
        ...
        if signal_type.lower() == "buy" and support_levels:
            ...
            if valid_supports:
                ...
                blended_stop = (base_stop * (1 - self.support_resistance_factor) + 
