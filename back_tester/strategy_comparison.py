...
class StrategyComparison:
    ...
    def add_strategy(
        self, name: str, backtest_func: Callable, parameters: Dict[str, Any] = {}
    ) -> None:
        """
    ...
    def run_comparison(
        ...
        **shared_params,
        ...
        common_params = {"initial_balance": initial_balance, **shared_params}
        ...
        if self.benchmark:
            ...
            try:
                benchmark_balance, benchmark_trades, benchmark_metrics = self.benchmark[
                    "func"
                ](**params)
    ...
    def _compile_comparison_results(self) -> Dict[str, Any]:
        ...
        if (
            self.benchmark
            and self.benchmark["results"]
            and self.benchmark["results"].get("metrics")
        ):
            strategy_metrics[self.benchmark["name"]] = self.benchmark["results"][
                "metrics"
            ]
        ...
        if self.benchmark and self.benchmark["name"] in strategy_metrics:
            ...
            for name in strategy_metrics:
                if name != benchmark_name:
                    ...
                    strategy_metrics[name]["vs_benchmark"] = (
    ...
    def plot_equity_curves(
        ...
        if (
            self.benchmark
            and self.benchmark["results"]
            and self.benchmark["results"].get("trades")
        ):
    ...
    **shared_params,
    ...
    if benchmark_func:
        comparison.add_benchmark(
            backtest_func=benchmark_func, parameters=benchmark_params or {}
        )
