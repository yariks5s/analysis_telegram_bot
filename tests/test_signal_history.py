...
class TestSignalHistory(unittest.TestCase):
    ...
    def test_get_signal_history_by_date_range(self, mock_get_conn):
        ...
        end_date = datetime.now().replace(hour=23, minute=59, second=59, microsecond=999999).isoformat()
        
        result = get_signal_history_by_date_range(self.test_user_id, start_date, end_date)
